package org.codecool.backend.security;


import org.codecool.backend.security.jwt.AuthEntryPointJwt;
import org.codecool.backend.security.jwt.AuthTokenFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable()).cors(cors -> cors.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/sunrise/**").hasRole("USER")
                        .requestMatchers("/api/sunset/**").hasRole("USER")
